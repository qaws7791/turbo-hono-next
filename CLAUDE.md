...
- **Session**: `SESSION_COOKIE_NAME`, `COOKIE_SECURE`, `COOKIE_DOMAIN`
- **OAuth**: `KAKAO_CLIENT_ID`, `KAKAO_CLIENT_SECRET`, `KAKAO_REDIRECT_URI`
- **Security**: `PASSWORD_HASH_SECRET`
- **Email**: `RESEND_API_KEY`, `RESEND_EMAIL`
- **File Storage**: `R2_*` 또는 `AWS_*` 변수들
- **Server**: `PORT`, `NODE_ENV`, `SERVICE_NAME`, `FRONTEND_URL`
