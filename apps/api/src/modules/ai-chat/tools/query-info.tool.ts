 ...
 */
export const createGetProgressTool = (userId: string) =>
  tool({
    description:
 ...
 */
export const createGetPlanDetailsTool = (userId: string) =>
  tool({
    description:
 ...
 */
export const createGetModuleDetailsTool = (userId: string) =>
  tool({
