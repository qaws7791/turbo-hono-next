...
export class EmailService {
  ...
  async sendMagicLink(
    ...
    const subject =
      type === "signup"
        ? `${CONFIG.SERVICE_NAME} 회원가입 인증`
        : `${CONFIG.SERVICE_NAME} 로그인 인증`;
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>© 2025 ${CONFIG.SERVICE_NAME}. All rights reserved.</p>
    ...
    await this.resend.emails.send({
      from: `${CONFIG.SERVICE_NAME} <noreply@${CONFIG.FRONTEND_URL}>`,
      to: email,
      subject,
      html,
    });
