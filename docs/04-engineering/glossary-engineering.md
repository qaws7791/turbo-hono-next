...
## SRS (Spaced Repetition) 용어

| 용어            | 정의                                | 예시                       |
| --------------- | ----------------------------------- | -------------------------- |
| **Interval**    | 다음 복습까지의 간격 (일 단위)      | 1일 → 3일 → 7일            |
| **Ease Factor** | 복습 간격 증가 비율을 결정하는 계수 | 2.5 (기본값)               |
| **Rating**      | 복습 시 사용자의 기억 정도 평가     | AGAIN / HARD / GOOD / EASY |
| **Due Date**    | 다음 복습 권장 시점                 | srs_due_at 필드            |
