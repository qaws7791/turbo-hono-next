...
홈은 '무엇을 할지'를 결정하는 곳이 아니라, **AI가 준비한 모든 Space의 오늘 학습을 한눈에 확인하고 시작하는 출발점**입니다.
...
- **모든 Space의 Active Plan에서 해야 할 항목을 전역으로 집계**하여 표시
...
**집계 대상**: 모든 Space의 Active Plan에서 현재(today)에 해당하는 Session/Review
...
| 필드 | 설명 |
|------|------|
| Space명 | 해당 세션이 속한 Space |
| Plan명 | 해당 세션이 속한 Plan |
...
- CTA: "아카이브에서 보기" (추후 확장: 세션 기준으로 묶어 보기)
...
- 스페이스를 이동하며 할 일을 찾는 행위가 필요 없음
- 홈에서 모든 Space의 할 일을 한눈에
