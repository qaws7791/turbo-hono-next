  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    Promise.all(
      files.map(async ({ id: _id, ...item }) => {
        void _id;
        // Destructure 'id' to omit it from 'item', addressing the requirement of FileUIPart[] Type
        // which does not include the internal 'id' property used for local UI state management.
