...
import { Menu, MenuItem, MenuPopover, MenuTrigger } from "../navigation/menu";
import { Popover, PopoverDialog, PopoverTrigger } from "../overlay/popover";
import {
  Select,
  SelectItem,
  SelectListBox,
...
export function PromptInputAttachment({
  ...
  return (
    <PopoverTrigger>
      ...
      <Popover className="w-auto p-2">
        <PopoverDialog className="w-auto space-y-3">
          {isImage && (
...
export function PromptInputAttachments({
  ...
  return (
    <div
      className={twMerge("flex flex-wrap items-center gap-2 p-3", className)}
      {...props}
    >
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    Promise.all(
      ...
      try {
        ...
        // TODO: Don't clear on error - user may want to retry
      }
    });
  };
    ...
    return (
      <InputGroupTextarea
        ...
        className={composeRenderProps(className, (className) =>
          twMerge("field-sizing-content max-h-48 min-h-16", className),
        )}
        name="message"
...
export const PromptInputHeader = ({
  ...
  <InputGroupAddon
    align="block-end"
    className={twMerge("order-first flex-wrap gap-1", className)}
    {...props}
  />
);
...
export const PromptInputFooter = ({
  ...
  <InputGroupAddon
    align="block-end"
    className={twMerge("justify-between gap-1", className)}
    {...props}
  />
);
...
export const PromptInputActionMenuButton = ({
  className,
  children,
  ...props
...
export const PromptInputActionMenuItem = ({
  ...
  <MenuItem
    className={composeRenderProps(className, (className) => twMerge(className))}
    {...props}
  />
);
...
export const PromptInputSelectContent = ({
  ...
  <SelectPopover>
    <SelectListBox
      className={composeRenderProps(className, (className) =>
        twMerge("bg-popover text-popover-foreground", className),
      )}
      {...props}
    />
  </SelectPopover>
