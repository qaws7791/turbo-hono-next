...
const searchFieldInputStyles = tv({
...
const searchFieldGroupStyles = tv({
  base: [
...
const searchFieldClearStyles = tv({
  base: [
...
interface FormSearchFieldProps extends AriaSearchFieldProps {
  label?: string;
  description?: string;
