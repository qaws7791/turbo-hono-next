...
export const GeneratedLearningModuleSchema = z.object({
  title: z.string().openapi({
    ...
    examples: ["HTML/CSS 기초"],
  }),
  description: z.string().openapi({
    description: "상위 목표 설명",
    examples: ["웹 개발의 기본이 되는 HTML과 CSS를 학습합니다"],
  }),
  order: z
    .number()
    .int()
...
export const GeneratedLearningPlanSchema = z.object({
  title: z.string().openapi({
    ...
    examples: ["JavaScript 풀스택 개발자 로드맵"],
  }),
  description: z.string().openapi({
    description: "로드맵 설명",
    examples: [
  ...
  .object({
    ...
    requestedAt: z
      ...
      .openapi({
        ...
        examples: ["2024-06-01T10:00:00.000Z"],
      }),
    completedAt: z
      .string()
      .datetime()
      ...
      .openapi({
        ...
        examples: ["2024-06-01T10:02:30.000Z"],
      }),
    errorMessage: z
      .string()
      .nullable()
      .openapi({
        ...
        examples: ["Gemini 호출이 실패했습니다. 잠시 후 다시 시도해주세요."],
      }),
  })
  .openapi({
...
export const LearningTaskQuizQuestionSchema = z
  .object({
    ...
    prompt: z
      ...
      .openapi({
        description: "문제 본문",
        examples: ["React 상태 관리를 위해 가장 적절한 훅은 무엇인가요?"],
      }),
    options: z
      .array(
        z
    ...
    explanation: z
      ...
      .openapi({
        description: "정답 해설",
        examples: [
          "`useState`는 로컬 상태 관리에 사용되는 React 기본 훅입니다.",
        ],
      }),
  })
  .openapi({
  ...
  .object({
    ...
    completedAt: z
      ...
      .openapi({
        ...
        examples: ["2024-06-01T10:02:00.000Z"],
      }),
    errorMessage: z
      .string()
      .nullable()
      .openapi({
        ...
        examples: ["Gemini API 호출이 실패했습니다."],
      }),
    questions: z
...
export const LearningTaskQuizEvaluationAnswerSchema =
  LearningTaskQuizPublicQuestionSchema.extend({
    ...
    explanation: z.string().openapi({
      description: "정답 설명",
      examples: ["이 선택지가 정답인 이유를 상세히 설명합니다."],
    }),
...
export const LearningTaskQuizEvaluationResultSchema = z
  .object({
    ...
    submittedAt: z
      ...
      .openapi({
        description: "제출 시각",
        examples: ["2024-06-01T10:05:00.000Z"],
      }),
  })
  .openapi({
